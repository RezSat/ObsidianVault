Yes, here’s a **Phase 4 AI prompt pack** you can copy task by task so the agents build the real backend safely.

Below is a clean pack designed for your exact system:
...
- strict docs and index updates
    
- small commits
    
- no file above 150 lines
...
1. give the AI **one prompt only**
    
2. let it complete only that task
...
# Global prefix prompt, use before every task

Paste this first before each task prompt.
...
- docs/standards/file-size-rules.md
...
Work only on the requested task. Do not implement unrelated features.
```
...
By end of Phase 4, you want:

- create product logic
    
- initialize inventory row on product creation
    
- stock adjustment transaction
    
- stock movement logging
    
- low stock query logic
    
- API routes for these
...
# Task 1, implement product creation repo and service
